...
export const PT_FOOD_SYNONYMS: Record<string, string[]> = {
  ...
  "bread-wholewheat": ["pao integral", "torrada integral", "pao escuro", "pao de trigo integral", "pao de centeio"],
  "bread-white": ["pao", "torrada", "pao branco", "pao de trigo", "pao de forma", "pao de mistura", "papo seco", "carcaca", "bolinha"],
