...
const rows: Row[] = [
  ...
  ["incline-bench-dumbbell", "Incline Dumbbell Press", "horizontal_push", ["chest", "shoulders"], ["triceps"], ["dumbbell"], true,
    { aliases: ["Incline Bench Press (Dumbbell)", "Incline Chest Press (Dumbbell)"], defaultRepRange: [8, 12] }],
  ["incline-chest-press-machine", "Machine Incline Chest Press", "horizontal_push", ["chest", "shoulders"], ["triceps"], ["machine"], true,
    { aliases: ["Incline Chest Press (Machine)", "Incline Press (Machine)"], defaultRepRange: [8, 12], skill: 1 }],
  ["chest-press-machine", "Machine Chest Press", "horizontal_push", ["chest"], ["triceps", "shoulders"], ["machine"], true,
    { aliases: ["Chest Press (Machine)", "Seated Chest Press", "Iso-Lateral Chest Press (Machine)"], defaultRepRange: [8, 12], skill: 1 }],
  ...
  ["pec-deck", "Pec Deck", "isolation", ["chest"], [], ["machine"], false,
    { aliases: ["Chest Fly (Machine)", "Butterfly", "Pec Deck (Machine)", "Pec Fly (Machine)"], defaultRepRange: [10, 15] }],
  ...
  ["rear-delt-fly", "Rear Delt Fly", "isolation", ["shoulders"], ["back"], ["dumbbell"], false,
    { aliases: ["Rear Delt Reverse Fly (Dumbbell)", "Reverse Fly (Dumbbell)", "Rear Delt Reverse Fly (Machine)", "Reverse Fly (Machine)", "Reverse Fly (Cable)"], defaultRepRange: [12, 20] }],
  ...
  ["dumbbell-row", "Dumbbell Row", "horizontal_pull", ["back", "lats"], ["biceps"], ["dumbbell"], true,
    { aliases: ["Bent Over Row (Dumbbell)", "Dumbbell Row", "Bent Over One Arm Row (Dumbbell)", "Single Arm Row (Dumbbell)"], defaultRepRange: [8, 12], unilateral: true }],
  ["seated-cable-row", "Seated Cable Row", "horizontal_pull", ["back"], ["lats", "biceps"], ["cable"], true,
    { aliases: ["Seated Row (Cable)", "Seated Cable Row", "Seated Row (Machine)", "Cable Row"], defaultRepRange: [8, 12], skill: 1 }],
  ["chest-supported-row", "Chest Supported Row", "horizontal_pull", ["back"], ["lats", "biceps"], ["machine", "dumbbell"], true,
    { aliases: ["Chest Supported Row (Machine)", "T Bar Row", "Iso-Lateral Row (Machine)", "Iso Lateral Row (Machine)", "Hammer Strength Row"], defaultRepRange: [8, 12] }],
  ...
  ["back-squat", "Barbell Back Squat", "squat", ["quads", "glutes"], ["hamstrings", "core"], ["barbell"], true,
    { aliases: ["Squat (Barbell)", "Back Squat", "Squat (Smith Machine)", "Smith Machine Squat"], defaultRepRange: [5, 8], skill: 3, met: 6,
  ...
  ["hack-squat", "Hack Squat", "squat", ["quads"], ["glutes"], ["machine"], true,
    { aliases: ["Hack Squat (Machine)", "Hack Squat"], defaultRepRange: [8, 12] }],
  ...
  ["skullcrusher", "Skullcrusher", "isolation", ["triceps"], [], ["barbell", "dumbbell"], false,
    { aliases: ["Skullcrusher (Barbell)", "Lying Triceps Extension", "Skullcrusher (Dumbbell)", "Skull Crusher"], defaultRepRange: [8, 12] }],
  ...
  ["running", "Running", "cardio", ["quads", "calves"], ["hamstrings", "glutes"], ["cardio"], false,
    { aliases: ["Running", "Run", "Treadmill", "Running (Treadmill)"], met: 9.8 }],
